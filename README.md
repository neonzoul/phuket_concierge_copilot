...
ANANT AGENT's Phuket Concierge Copilot demo.

**Read `spec/architecture-proposal.md` and `spec/implementation-plan.md` first** — they are the
authority for what this repo implements and what's still open. See also `CLAUDE.md` for the
build-phase TODO.
...
`apps/web` (Guest Chat / Staff Dashboard UI) does not exist yet — see `spec/implementation-plan.md`'s
"next concrete steps."
